"""Optional HTTP Basic Auth middleware for the Switchly dashboard."""
...
class BasicAuthMiddleware(BaseHTTPMiddleware):
    ...
    When *auth* credentials are provided to :func:`SwitchlyDashboard`, this
    ...
    def _challenge() -> Response:
        ...
        return Response(
            status_code=401,
            headers={"WWW-Authenticate": 'Basic realm="Switchly Dashboard"'},
