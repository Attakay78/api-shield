"""SwitchlyEngine — the central orchestrator for switchly.
...
from switchly.core.webhooks import default_formatter
...
class _SyncProxy:
    """Synchronous façade over :class:`SwitchlyEngine`.
    ...
    switchly decorators use, so no event-loop wiring is needed.
    ...
    def enable(
        ...
        """Sync version of :meth:`SwitchlyEngine.enable`."""
    ...
    def disable(
        ...
        """Sync version of :meth:`SwitchlyEngine.disable`."""
    ...
    def set_maintenance(
        ...
        """Sync version of :meth:`SwitchlyEngine.set_maintenance`."""
        return self._run(
    ...
    def schedule_maintenance(
        ...
        """Sync version of :meth:`SwitchlyEngine.schedule_maintenance`."""
        self._run(
    ...
    def set_env_only(
        ...
        """Sync version of :meth:`SwitchlyEngine.set_env_only`."""
    ...
    def get_global_maintenance(self) -> GlobalMaintenanceConfig:
        """Sync version of :meth:`SwitchlyEngine.get_global_maintenance`."""
    ...
    def enable_global_maintenance(
        ...
        """Sync version of :meth:`SwitchlyEngine.enable_global_maintenance`."""
        return self._run(
    ...
    def disable_global_maintenance(
        ...
        """Sync version of :meth:`SwitchlyEngine.disable_global_maintenance`."""
    ...
    def set_global_exempt_paths(self, paths: list[str]) -> GlobalMaintenanceConfig:
        """Sync version of :meth:`SwitchlyEngine.set_global_exempt_paths`."""
    ...
    def get_service_maintenance(self, service: str) -> GlobalMaintenanceConfig:
        """Sync version of :meth:`SwitchlyEngine.get_service_maintenance`."""
    ...
    def enable_service_maintenance(
        ...
        """Sync version of :meth:`SwitchlyEngine.enable_service_maintenance`."""
        return self._run(
    ...
    def disable_service_maintenance(
        ...
        """Sync version of :meth:`SwitchlyEngine.disable_service_maintenance`."""
        return self._run(
    ...
    def set_rate_limit_policy(
        ...
        *,
        ...
        """Sync version of :meth:`SwitchlyEngine.set_rate_limit_policy`."""
        return self._run(
    ...
    def delete_rate_limit_policy(
        ...
        """Sync version of :meth:`SwitchlyEngine.delete_rate_limit_policy`."""
        self._run(
    ...
    def get_rate_limit_hits(self, path: str | None = None, limit: int = 100) -> list[Any]:
        """Sync version of :meth:`SwitchlyEngine.get_rate_limit_hits`."""
    ...
    def reset_rate_limit(
        ...
        """Sync version of :meth:`SwitchlyEngine.reset_rate_limit`."""
        self._run(
    ...
    def set_global_rate_limit(
        ...
        *,
        ...
        """Sync version of :meth:`SwitchlyEngine.set_global_rate_limit`."""
        return self._run(
    ...
    def get_global_rate_limit(self) -> Any:
        """Sync version of :meth:`SwitchlyEngine.get_global_rate_limit`."""
    ...
    def delete_global_rate_limit(self, *, actor: str = "system", platform: str = "system") -> None:
        """Sync version of :meth:`SwitchlyEngine.delete_global_rate_limit`."""
    ...
    def reset_global_rate_limit(self, *, actor: str = "system", platform: str = "system") -> None:
        """Sync version of :meth:`SwitchlyEngine.reset_global_rate_limit`."""
    ...
    def enable_global_rate_limit(self, *, actor: str = "system", platform: str = "system") -> None:
        """Sync version of :meth:`SwitchlyEngine.enable_global_rate_limit`."""
    ...
    def disable_global_rate_limit(self, *, actor: str = "system", platform: str = "system") -> None:
        """Sync version of :meth:`SwitchlyEngine.disable_global_rate_limit`."""
    ...
    def get_service_rate_limit(self, service: str) -> Any:
        """Sync version of :meth:`SwitchlyEngine.get_service_rate_limit`."""
    ...
    def set_service_rate_limit(
        ...
        *,
        ...
        """Sync version of :meth:`SwitchlyEngine.set_service_rate_limit`."""
        return self._run(
...
class SwitchlyEngine:
    ...
    def __init__(
        ...
        self.backend: SwitchlyBackend = backend or MemoryBackend(
        ...
        self._rate_limit_backend: SwitchlyBackend | None = rate_limit_backend
        ...
        self._rate_limiter: Any = None  # SwitchlyRateLimiter | None
        ...
        self._flag_provider: Any = None  # SwitchlyOpenFeatureProvider | None
        self._flag_client: Any = None  # SwitchlyFeatureClient | None
    ...
    async def __aenter__(self) -> SwitchlyEngine:
        """Call ``backend.startup()``, start background tasks, and return *self*.

        Use ``async with SwitchlyEngine(...) as engine:`` to ensure the
    ...
    async def start(self) -> None:
        ...
        * ``switchly-global-config-listener`` — invalidates the in-process
        ...
        * ``switchly-route-state-listener`` — bumps ``_schema_version``
        ...
        * ``switchly-rl-policy-listener`` — syncs rate limit policy changes
        ...
        if self._global_listener_task is None or self._global_listener_task.done():
            self._global_listener_task = asyncio.create_task(
                ...
                name="switchly-global-config-listener",
            )
        if self._route_state_listener_task is None or self._route_state_listener_task.done():
            self._route_state_listener_task = asyncio.create_task(
                ...
                name="switchly-route-state-listener",
            )
        if self._rl_policy_listener_task is None or self._rl_policy_listener_task.done():
            self._rl_policy_listener_task = asyncio.create_task(
                ...
                name="switchly-rl-policy-listener",
            )
    ...
    def use_openfeature(
        ...
        provider:
            ...
            ``SwitchlyOpenFeatureProvider(self.backend)`` — the built-in
        ...
        ------
        ImportError
            When ``switchly[flags]`` is not installed.
        """
        ...
        from switchly.core.feature_flags.hooks import LoggingHook
        from switchly.core.feature_flags.provider import SwitchlyOpenFeatureProvider

        if provider is None:
            provider = SwitchlyOpenFeatureProvider(self.backend)
        ...
        from switchly.core.feature_flags.hooks import MetricsHook
        ...
        self._flag_client = SwitchlyFeatureClient(domain=domain)
    ...
    @property
    def flag_client(self) -> Any:
        """Return the active ``SwitchlyFeatureClient``, or ``None`` if not configured.
    ...
    async def _run_global_config_listener(self) -> None:
        ...
        try:
            async for _ in self.backend.subscribe_global_config():
                ...
                logger.debug("switchly: global config cache invalidated by remote change")
            ...
            logger.exception(
                "switchly: global config listener crashed — invalidating cache as a precaution"
            )
            self._invalidate_global_config_cache()
            self._bump_schema_version()
    ...
    async def _run_route_state_listener(self) -> None:
        ...
        try:
            async for _ in self.backend.subscribe():
                self._bump_schema_version()
                logger.debug("switchly: schema version bumped by remote route state change")
        except NotImplementedError:
            ...
            logger.exception(
                "switchly: route state listener crashed — bumping schema version as a precaution"
            )
            self._bump_schema_version()
        ...
        try:
            async for event in self.backend.subscribe_rate_limit_policy():
                ...
                if action == "set":
                    ...
                    if policy_data:
                        try:
                            from switchly.core.rate_limit.models import RateLimitPolicy
                            ...
                            logger.debug("switchly: rl policy synced from remote change: %s", key)
                        except Exception:
                            logger.exception(
                                "switchly: failed to apply remote rl policy change for %r", key
                            )
                elif action == "delete":
                    self._rate_limit_policies.pop(key, None)
                    logger.debug("switchly: rl policy deleted by remote change: %s", key)
        except NotImplementedError:
            pass  # backend doesn't support pub/sub — per-process dict is the only store
        except asyncio.CancelledError:
            raise
        except Exception:
            logger.exception("switchly: rl policy listener crashed")
    ...
    async def check(
        ...
        It raises a ``SwitchlyException`` subclass when the request should
        ...
        the request is allowed through — switchly never takes down an API.
        ...
        try:
            ...
            logger.exception("switchly: backend error reading global config — failing open")
    ...
    async def _resolve_state(self, path: str, method: str | None) -> RouteState | None:
        ...
        for key in candidates:
            try:
                ...
                logger.exception("switchly: backend error reading state for %r — failing open", key)
    ...
    # ------------------------------------------------------------------
    # Registration (called by SwitchlyRouter at startup)
    # ------------------------------------------------------------------

    async def register(self, path: str, meta: dict[str, Any]) -> None:
        """Register a route from its ``__switchly_meta__`` decorator stamp.

        Called by ``SwitchlyRouter`` at application startup for every route
        that carries switchly metadata.
    ...
    async def register_batch(self, routes: list[tuple[str, dict[str, Any]]]) -> None:
        ...
        routes:
            ...
            ``SwitchlyRouter._switchly_routes``.
        """
        if not routes:
            return
        ...
        # SwitchlyServerBackend which adds a service prefix) correctly
        # compare against plain local paths.
        try:
            existing_keys: set[str] = await self.backend.get_registered_paths()
        except Exception:
            logger.exception(
                "switchly: register_batch — failed to list existing states, "
    ...
    async def enable(
        ...
        reason:
            ...
            on the route state so the reason is visible in ``switchly status``.
        """
    ...
    def _service_global_key(service: str) -> str:
        return f"__switchly:svc_global:{service}__"
    ...
    def _fire_webhooks(self, event: str, path: str, state: RouteState) -> None:
        ...
        asyncio.create_task(
            ...
            name=f"switchly-webhook:{event}:{path}",
        )
    ...
    async def _dispatch_webhooks(self, event: str, path: str, state: RouteState) -> None:
        ...
        try:
            ...
            logger.warning("switchly: webhook dedup check raised unexpectedly — firing anyway")
            claimed = True  # fail-open: over-deliver rather than miss

        if not claimed:
            logger.debug(
                "switchly: webhook dispatch for %r/%s already claimed by another instance"
                " — skipping",
                event,
                path,
            )
        ...
        for url, formatter in self._webhooks:
            ...
            asyncio.create_task(
                ...
                name=f"switchly-webhook-post:{event}:{path}",
            )
    ...
    async def _post_webhook(url: str, payload: dict[str, Any]) -> None:
        ...
        try:
            ...
            logger.exception("switchly: webhook POST to %r failed", url)
    ...
    async def _ensure_rate_limiter(self) -> None:
        ...
        if self._rate_limiter is not None:
            return
        try:
            from switchly.core.rate_limit.limiter import SwitchlyRateLimiter
            from switchly.core.rate_limit.storage import create_rate_limit_storage
            ...
            self._rate_limiter = SwitchlyRateLimiter(
                storage=storage,
            ...
            raise ImportError(
                ...
                "Install it with: pip install switchly[rate-limit]"
            ) from None
    ...
    async def register_rate_limit(
        ...
        importing ``switchly`` without the ``limits`` library installed works
    ...
    async def _record_rate_limit_hit(
        ...
        """
        try:
            from switchly.core.rate_limit.models import RateLimitHit
            ...
            logger.exception("switchly: failed to record rate limit hit for %r", path)
    ...
    async def set_rate_limit_policy(
        ...
        *,
        ...
        logger.info(
            "switchly: rate limit policy %s for %s %s (%s) by %s",
    ...
    async def delete_rate_limit_policy(
        ...
        *,
        ...
        logger.info("switchly: rate limit policy deleted for %s %s by %s", method, path, actor)
        await self._audit_rl(
            path=key,
    ...
    async def restore_rate_limit_policies(self) -> None:
        ...
        try:
            ...
            logger.exception("switchly: failed to restore rate limit policies from backend")
            return
        ...
        for policy_data in policy_dicts:
            try:
                ...
                logger.exception("switchly: failed to restore rate limit policy %r", policy_data)
    ...
    async def _restore_global_rate_limit_policy(self) -> None:
        ...
        try:
            ...
            logger.exception("switchly: failed to restore global rate limit policy from backend")
            return
        ...
        try:
            from switchly.core.rate_limit.models import GlobalRateLimitPolicy

            self._global_rate_limit_policy = GlobalRateLimitPolicy.model_validate(policy_data)
            logger.info(
                "switchly: restored global rate limit policy (%s)",
                self._global_rate_limit_policy.limit,
            )
        except Exception:
            logger.exception("switchly: failed to parse persisted global rate limit policy")
    ...
    async def set_global_rate_limit(
        ...
        *exempt_routes*.  Persisted so the policy survives restarts.
        ...
        logger.info(
            "switchly: global rate limit policy %s (%s) by %s",
            "updated" if is_update else "set",
            limit,
            actor,
        )
    ...
    async def delete_global_rate_limit(
        ...
        *,
        ...
        logger.info("switchly: global rate limit policy deleted by %s", actor)
        await self._audit_rl(
            path="__global_rl__",
    ...
    async def _restore_service_rate_limit_policies(self) -> None:
        ...
        try:
            ...
            logger.exception("switchly: failed to restore service rate limit policies from backend")
            return
        ...
        for service, policy_data in all_policies.items():
            try:
                ...
                logger.info("switchly: restored service rate limit policy for %r", service)
            except Exception:
                logger.exception(
                    "switchly: failed to parse service rate limit policy for %r", service
                )
    ...
    def _service_rl_key(service: str) -> str:
        return f"__switchly:svc_rl:{service}__"
    ...
    async def set_service_rate_limit(
        ...
        *,
        ...
        logger.info(
            "switchly: service rate limit policy %s for %r (%s) by %s",
            "updated" if is_update else "set",
            service,
            limit,
            actor,
    ...
    async def delete_service_rate_limit(
        ...
        *,
        ...
        logger.info("switchly: service rate limit policy deleted for %r by %s", service, actor)
        await self._audit_rl(
            path=self._service_rl_key(service),
    ...
    async def list_states(self) -> list[RouteState]:
        ...
        return [s for s in states if not s.path.startswith("__switchly:")]
