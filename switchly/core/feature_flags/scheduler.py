...
Supported :class:`~switchly.core.feature_flags.models.ScheduledChangeAction`\\ s:
...
class FlagScheduler:
    ...
    ----------
    engine:
        The :class:`~switchly.core.engine.SwitchlyEngine` used to read and
        write flags.
    """
    ...
    async def start(self) -> None:
        ...
        Called by ``SwitchlyEngine.start()`` when feature flags are enabled.
        """
        try:
    ...
    async def schedule(self, flag_key: str, change: Any) -> None:
        ...
        change:
            A :class:`~switchly.core.feature_flags.models.ScheduledChange`
    ...
    def _create_task(self, flag_key: str, change: Any) -> asyncio.Task[None]:
        task = asyncio.create_task(
            ...
            name=f"switchly-flag-scheduler:{flag_key}:{change.id}",
        )
    ...
    async def _apply_change(self, flag_key: str, change: Any) -> None:
        ...
        from switchly.core.feature_flags.models import ScheduledChangeAction, TargetingRule
