"""SwitchlyFeatureClient — OpenFeature-backed flag evaluation API.
...
class _SyncSwitchlyFeatureClient:
    """Synchronous façade over :class:`SwitchlyFeatureClient`.
    ...
    def __init__(self, of_client: object) -> None:
        # ``of_client`` is the raw openfeature Client, not SwitchlyFeatureClient.
    ...
    def get_boolean_value(
        ...
        from switchly.core.feature_flags._context import to_of_context
